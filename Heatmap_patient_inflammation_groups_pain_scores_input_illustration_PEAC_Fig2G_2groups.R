...
pain_scores_infla <- pain_scores_infla[pain_scores_infla$`Inflammation Level`!='2.Mixed', ] # Drop the confusing Mixed group.
...
gex_sorted <- gex_sorted[row.names(ls_sorted), row.names(annotation_col)]
...
annotation_colors = list(
  ...
  `Inflammation Level` = c(`1.High`="orange", `3.Low`="green"),
...
fn <- "Heatmap.low_inflammatory_genes_patients_pain_scores_inflammation_levels_in_PEAC_Fig2G_2groups.png"

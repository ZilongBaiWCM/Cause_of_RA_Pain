...
colnames(annotation_row) <- c('Laplacian Score', 'PAGGI-identified')

annotation_colors = list(
  `Inflammation Level` = c(`Low (combined)`="pink", High="#B22222"),
  ...
  `PAGGI-identified` = c(Yes="#B22222", No="cyan"))

save_plot_dir <- '/Users/baizilong/Documents/Dana-dataset/RA_paper/'
fn <- "Heatmap.low_inflammatory_genes_patients_pain_scores_inflammation_levels_ls_sorted_input_SupFig1B.png"

...
#ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper/hss_summary_scores_vs_pain_scores_pain_genes_Fig2",".png",sep=""))
#dev.off()
######
...
sp_ls.tsne + 
  ...
  scale_y_continuous(limits=c(0, 60)) +  #name="HOOS/KOOS Pain Score", 
  labs(x=NULL, y=NULL)
#ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper/hss_summary_scores_vs_pain_scores_low_infla_genes_paper_Fig2",".png",sep=""))
#dev.off()
